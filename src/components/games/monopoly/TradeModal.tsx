              ...
              <div className="h-full flex flex-col">
                ...
                <div className="p-4 bg-[#222] border-t border-slate-700 flex justify-end">
                    <Button
                        ...
                        className={`font-bold py-3 px-8 text-lg shadow-lg transition-all ${
                            targetPlayer 
                                            ...
                                            <div className="flex flex-col md:flex-row gap-4 mb-6">
                                                ...
                                                <div className="flex-1 bg-[#1a1a1a] rounded p-3 border border-slate-700/50">
                                                    ...
                                                    {trade.requestingCash > 0 && (
                                                        <div className="inline-block px-2 py-1 bg-blue-900/20 text-blue-400 text-sm font-bold rounded mb-2 border border-blue-900/30">
