...
// SVG Chess Pieces styled like Chess.com (neo pieces)
export function ChessPiece({ piece, size = 80 }: ChessPieceProps) {
    const isWhite = piece === piece.toUpperCase();
    const pieceType = piece.toLowerCase();

    const fillColor = isWhite ? "#fff" : "#312e2b";
    const strokeColor = isWhite ? "#312e2b" : "#000";
