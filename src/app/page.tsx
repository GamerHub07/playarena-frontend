    ...
    <div className="min-h-screen bg-[var(--background)] bg-pattern">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center bg-[var(--surface)] p-8 md:p-12 rounded-[2rem] shadow-card border border-[var(--border)] relative overflow-hidden group">
              ...
              <div className="absolute top-8 right-8 text-indigo-500/20 rotate-12 transition-transform duration-700 group-hover:rotate-45 group-hover:scale-110">
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM7 7h2v2H7V7zm10 10h-2v-2h2v2zm0-4h-2v-2h2v2zm-4 4h-2v-2h2v2zm0-4h-2v-2h2v2zm-4 4H7v-2h2v2zm0-4H7v-2h2v2z" />
                </svg>
              </div>
              ...
              <div className="absolute top-1/2 right-0 text-emerald-400/20 translate-x-1/2 -translate-y-1/2">
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2v2c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V21h4c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z" />
                </svg>
              </div>
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[var(--dark)] mb-6 leading-[0.95] tracking-tight">
                  ...
                  <span className="text-[var(--primary)] relative inline-block">
                    Together.
                    <svg
                      className="absolute w-full h-3 -bottom-1 left-0 text-[var(--secondary)] opacity-40"
                      viewBox="0 0 100 10"
                ...
                <p className="text-xl text-[var(--text-muted)] mb-8 max-w-lg leading-relaxed font-medium">
                  Join the arena. No downloads, no signups. Just pure
                  multiplayer fun right in your browser.
                </p>
              ...
              {GAMES.map((game, i) => (
                <Link
                  ...
                  className={`
                    ...
                    ${
                      !game.available
                        ? "opacity-90 grayscale-[0.5] hover:grayscale-0"
                        : ""
                    }
                  `}
                >
          ...
          <section id="how-it-works" className="py-12">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-4xl font-bold text-[var(--dark)] mb-4">
                Simple as 1-2-3
              </h2>
              <p className="text-lg text-[var(--text-muted)]">
                We removed all the friction. You are just seconds away from
      ...
      <footer className="py-12 text-center text-[var(--text-muted)] border-t border-[var(--border)] mt-12 bg-[var(--surface)]">
        ...
        <p className="mb-2 font-medium">
          © {new Date().getFullYear()} PlayArena
        </p>
