        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-[#888] max-w-md mx-auto">
              Multiplayer Texas Hold’em poker. Bet, bluff, and outplay your
              opponents to win the pot.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            <Card className="p-8 text-center">
              ...
              <p className="text-sm text-[#888] mb-6">
                Host a poker table and invite friends
              </p>
              <Button
            ...
            {/* Join */}
            <Card className="p-8 text-center">
              <div className="w-16 h-16 bg-[#f59e0b]/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-sm text-[#888] mb-6">
                Enter a room code to join a live table
              </p>
              <Button
                variant="secondary"
          ...
          <div className="mt-16 max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { icon: '🂡', text: 'Each player gets 2 private cards' },
                { icon: '🃎', text: '5 community cards are revealed' },
